...
export class Ec2FinderStack extends Construct {
    ...
    readonly finder_template: ec2.LaunchTemplate;
    ...
    constructor(scope: Construct, id: string, props: Ec2FinderProps) {
        ...
        this.finderRole.addManagedPolicy(iam.ManagedPolicy.fromAwsManagedPolicyName('AmazonSSMManagedInstanceCore'));
        ...
        const instanceTypeName = instanceTypeTable.findInMap(props.ec2Memory, 'instanceType')
        ...
        const CronExpression = Fn.conditionIf(enableFinderTrigger.logicalId, '0/60 * * * ? 2000', props.ec2CronExpression)
